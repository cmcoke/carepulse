...
const AppointmentModal = ({ type, patientId, userId, appointment }: { patientId: string; userId: string; appointment?: Appointment; type: "schedule" | "cancel"; title: string; description: string }) => {
