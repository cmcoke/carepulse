...
const Success = async (props: { searchParams: Promise<{ appointmentId?: string }>; params: Promise<{ userId: string }> }) => {
    ...
    <div className="flex h-screen max-h-screen px-[5%]">
      <div className="success-img">
        ...
        <section className="flex flex-col items-center">
          <Image src="/assets/gifs/success.gif" height={300} width={280} alt="success" unoptimized={true} />
